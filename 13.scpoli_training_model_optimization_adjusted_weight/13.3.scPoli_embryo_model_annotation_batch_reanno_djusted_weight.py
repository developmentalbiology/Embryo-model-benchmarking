...
source_adata = sc.read('/storage2/liuxiaodongLab/fanxueying/embryo_benchmarking_rebuttal/code/20250731_scpoli_optimization_comparasion_v3/ref_training_balance_weight/method3_balanced_weighted_reanno/adata.h5ad')
source_adata


# Train reference model for "reanno" (only once)
...
reference_model_dir = '/storage2/liuxiaodongLab/fanxueying/embryo_benchmarking_rebuttal/code/20250731_scpoli_optimization_comparasion_v3/ref_training_balance_weight/method3_balanced_weighted_reanno/'
...
figures_folder = './method3_balanced_weighted_reanno/figures'
...
for h5ad_file in h5ad_files:
    ...
    try:
        ...
        query_adata_extended.obs['reanno'] = 'Unknown'
        ...
        sc.pl.umap(
            ...
            show=False,
            frameon=False,
            save=f'_{file_name}_scPoli_reanno.png'
        )
        sc.pl.umap(
            adata_no_prototypes,
            color='orig.ident',
