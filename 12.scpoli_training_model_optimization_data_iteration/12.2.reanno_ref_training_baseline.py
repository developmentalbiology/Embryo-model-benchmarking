...
reference_model_dir = './reanno_model_hvg2000_dim80/'
...
# 1. plot cell type
plt.figure()
sc.pl.umap(source_adata, color=cell_type_key, title=f'UMAP by {cell_type_key}', frameon=False, show=True, save="ref_training_reanno_hvg2000_dim80.pdf")

# 2. plot batch 
plt.figure()
sc.pl.umap(source_adata, color=condition_key, title=f'UMAP by {condition_key} (Batch)', frameon=False, show=True,save="batch_hvg2000_dim80.pdf")