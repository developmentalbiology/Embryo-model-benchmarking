...
# load data
cs7 <- readRDS("/storage2/liuxiaodongLab/fanxueying/developmental_atlas/human_spatial/CS7_human_embryo.rds")
...
#counts <- cs7@assays[["RNA"]]@counts
counts <- cs7[["RNA"]]$counts   #for seurat5
#get xy coordinates
coords <- cs7@meta.data[,c("newx","newy")]
...
saveRDS(RCTD, file = "RCTD_human_cs7_leiden_3_20250724_v3.rds")
