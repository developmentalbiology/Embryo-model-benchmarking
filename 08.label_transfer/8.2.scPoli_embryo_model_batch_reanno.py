...
os.chdir('/storage2/liuxiaodongLab/fanxueying/embryo_benchmarking_rebuttal/code/20250724_scpoli_batch_reanno_v3/reanno')
os.getcwd()
...
reference_model_dir = './scPoli/reference_model/'
