...
os.chdir('/storage2/liuxiaodongLab/fanxueying/embryo_benchmarking_rebuttal/code/20250724_scpoli_batch_reanno_v3/lineage')
os.getcwd()
...
# extract uns, obsm, varm and reorganize the adata_hvg
adata_hvg.uns = {}
adata_hvg.obsm = {}
adata_hvg.varm = {}
...
figures_folder = './figures_lineage'
