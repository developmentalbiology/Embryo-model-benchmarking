...
setwd("D:/xueying-work/afterPHD/Liu-lab/project1-embryo benchmarking/2024April/manuscript/NCB_rebuttal_2025_june/code/20250708_RCTD_monkey-optimization")
...
# RCTD results
#reload dataset
cs8 <- readRDS("D:/xueying-work/afterPHD/Liu-lab/project1-embryo benchmarking/2024April/manuscript/final code/20250102_RCTD_jia_monkey_prediction/sobj_CS910_spateo_341.rds")
#cs8 <- readRDS("sobj_CS910_spateo_341.rds")
RCTD <- readRDS( "D:/xueying-work/afterPHD/Liu-lab/project1-embryo benchmarking/2024April/manuscript/NCB_rebuttal_2025_june/code/20250706_monkey_RCTD_reanno/RCTD_cs910_monkey_reanno_20250706.rds")


#get xy coordinates
xy <- cs8@reductions$Spatial45@cell.embeddings
xy <- as.matrix(xy)
colnames(xy) <- c("x","y")
...
source("multi_tier_integrated_final.R")

# Apply to your data with TE lineage and hypoblast exclusion
results <- multi_tier_assignment_integrated_final(
  ...
  excluded_cell_types = c('TE', 'CTB_1','CTB_2','CTB_3','CTB_4', 'STB_1','STB_2', 'EVT_1','EVT_2', 'Hypoblast'
                          ),
  ...
  suppressed_cell_types = c("Somite", 'Ectoderm_2',"YS.endoderm_2", "Epiblast_2"),        
  max_suppressed_proportion = 0.05,           
  suppression_strength = 0.5,                 
  
  # Weak signal protection parameters
  weak_signal_protected_types = c("Gut_surface_ectoderm","Amniotic.epi","DE", "YS.mesoderm"),
...
mean(results$final_assignment == "TE")  # Should be 0%
...
pdf(paste0(outputDir, "/Jia_CS910_RCTD_full_top.pdf"), width = 22, height = 13)
p
...
saveRDS(
  object = cs8,
  file = "monkey_Jia_CS910.Rds"
)

cs8 <- readRDS("monkey_Jia_CS910.Rds")
